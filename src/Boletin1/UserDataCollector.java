...
public class UserDataCollector {
	 ...
	 * max. Repite la operación hasta que se introduce un número entero comprendido
	 * entre min y max.
	 * 
	 * @param mensaje El mensaje que se mostrará
	...
	/**
	 * Muestra un mensaje por pantalla y solicita una cadena. Repite la operación
	 * hasta que se introduce una cadena válida.
	 * 
	 * @param mensaje El mensaje que se mostrará
	 ...
	 * comprendida entre una serie de opciones válidas Repite la operación hasta que
	 * se introduce una cadena válida.
	 * 
	 * @param mensaje  El mensaje que se mostrará
